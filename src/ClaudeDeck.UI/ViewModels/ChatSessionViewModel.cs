...
using ClaudeDeck.UI.ViewModels.Banners;
...
public partial class ChatSessionViewModel : ObservableObject, IDisposable
{
    ...
    public ChatSessionViewModel(IChatService chatService, OutputListener outputListener, IOptions<ClaudeDeckOptions> options)
