...
namespace ClaudeDeck.VSExtension.Commands;
...
public class OpenChatSessionCommand : Command
{
    ...
    public override CommandConfiguration CommandConfiguration => new("ClaudeDeck")
    {
    ...
    public override async Task ExecuteCommandAsync(IClientContext context, CancellationToken cancellationToken)
    {
        ...
        await ClaudeDeckPackage.ShowChatSessionWindowAsync();
    }
}
