...
namespace ClaudeDeck.VSExtension
{
    ...
    /// (ClaudeDeck.VSExtension.BindingRedirects.pkgdef) that registered
    ...
    internal static class AssemblyResolveBootstrap
    {
        ...
        {
            // Write to %LOCALAPPDATA%\ClaudeDeck\resolver.log. Separate file
            // from the main Serilog sink because the resolver runs at
            // module-load time, well before ClaudeDeckPackage wires up
